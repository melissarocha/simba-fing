...
if ( !empty($_POST) ) {
    ...
    if ( $valid ) {
        ...
        $sql = "UPDATE usuarios SET nombre_usuario = ?, correo_electronico = ?, contrasena = ?, id_control_acceso = ? WHERE id_usuario = ?;";
        $q = $pdo -> prepare($sql);
        $q -> execute(array($nombre_usuario, $correo_electronico, $contrasena, $id_control_acceso, $id_usuario));
        Database::disconnect();
        header("Location: usuarios.php");
    }
} else {
...
//    $contrasena = $data['contrasena'];
    $id_control_acceso = $data['tipo_usuario'];
    Database::disconnect();
}
?>
...
<div class="container">
    <div class="span10 offset1">
        ...
        <form class="form-horizontal" action="edit.php?id_usuario=<?php echo $id_usuario?>" method="post">
